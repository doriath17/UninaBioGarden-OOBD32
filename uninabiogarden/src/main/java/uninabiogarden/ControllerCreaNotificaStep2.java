...
public class ControllerCreaNotificaStep2 {
    ...
    @FXML private TableView<Coltivatore> availableColtivatoriTable;

    @FXML private TableColumn<Coltivatore, String> availableNomeColumn;

    @FXML private TableColumn<Coltivatore, String> availableUsernameColumn;

    @FXML private TableColumn<Coltivatore, Void> availableSelectionColumn;

    @FXML private TableView<Coltivatore> selectedColtivatoriTable;

    @FXML private TableColumn<Coltivatore, String> selectedNomeColumn;

    @FXML private TableColumn<Coltivatore, String> selectedUsernameColumn;

    @FXML private TableColumn<Coltivatore, Void> selectedSelectionColumn;

    @FXML private Label errorLabel;

    @FXML private VBox mainContent;

    @FXML private ChoiceBox<String> yesNoBox;

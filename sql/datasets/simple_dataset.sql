...
INSERT INTO progetto (nome, descrizione, stato, data_inizio,  id_proprietario, id_lotto) VALUES
('Orto Primavera 2025', 'Coltivazione di ortaggi stagionali primaverili', 'ATTIVO', '2025-03-01',  1, 1),
('Erbe Aromatiche Bio', 'Progetto dedicato alla coltivazione biologica di erbe aromatiche', 'ATTIVO', '2025-02-15', 1, 3),
('Orto Estivo 2024', 'Progetto estivo con ortaggi da frutto', 'ATTIVO', '2024-06-01', 1, 2),
('Legumi Autunnali', 'Coltivazione di legumi per l''autunno', 'ATTIVO', '2025-09-01', 1, 4);
...
('Controllare espansione, cresce velocemente', 'ATTIVA', 'OTTIMO', '2025-02-18', 2, 3), -- Menta
('Semina scaglionata per raccolta continua', 'ATTIVA', 'STABILE', '2025-02-18', 2, 4); -- Prezzemolo

-- Progetto 3: Orto Estivo 2024 (CONCLUSO)
INSERT INTO coltivazione (note_tecniche, stato, stato_salute, data_inizio, id_progetto, id_coltura) VALUES
('Raccolta completata a settembre', 'ATTIVA', 'STABILE', '2024-06-05', 3, 6), -- Zucchina Romanesca
('Ottima produzione estiva', 'ATTIVA', 'OTTIMO', '2024-06-10', 3, 7), -- Peperone Quadrato
('Maturazione tardiva, raccolto abbondante', 'ATTIVA', 'STABILE', '2024-06-08', 3, 8); -- Melanzana Violetta
...
('Semina Pomodori', 'PIANIFICATA', '2025-02-28', '2025-03-05', '2025-03-07', 'Semenzaio protetto con temperatura 20-25°C', 1, 2),
('Irrigazione Pomodori', 'PIANIFICATA', '2025-03-10', '2025-03-12', '2025-03-14', 'Irrigazione a goccia programmata', 1, 2),
('Concimazione Pomodori', 'PIANIFICATA', '2025-03-15', '2025-03-18', '2025-03-20', 'Concime organico ricco di azoto', 1, 3),
...
('Semina Lattuga', 'PIANIFICATA', '2025-03-08', '2025-03-10', 'Semina diretta in file distanziate 25cm', 2, 3),
('Irrigazione Lattuga', 'PIANIFICATA', '2025-03-15', '2025-03-16', 'Irrigazione leggera quotidiana', 2, 3),
...
INSERT INTO attivita (nome, stato, data_pianificazione, data_inizio, note_tecniche, id_coltivazione, id_coltivatore) VALUES
('Semina Rucola', 'PIANIFICATA', '2025-03-06', '2025-03-08', 'Semina a spaglio in aiuole preparate', 3, 2),
...
INSERT INTO attivita (nome, stato, data_pianificazione, data_inizio, note_tecniche, id_coltivazione, id_coltivatore) VALUES
('Semina Basilico', 'PIANIFICATA', '2025-02-18', '2025-02-20', 'Semenzaio con terriccio leggero', 4, 4),
('Trapianto Basilico', 'PIANIFICATA', '2025-03-05', '2025-03-08', 'Trapianto in pieno campo', 4, 2),
('Irrigazione Basilico', 'PIANIFICATA', '2025-03-10', '2025-03-12', 'Irrigazione regolare mattutina', 4, 4);

-- Attività per Coltivazione 5 (Rosmarino - Progetto 2)
INSERT INTO attivita (nome, stato, data_pianificazione, data_inizio, note_tecniche, id_coltivazione, id_coltivatore) VALUES
('Trapianto Rosmarino', 'PIANIFICATA', '2025-02-18', '2025-02-20', 'Talee radicate trapiantate', 5, 2),
('Potatura Rosmarino', 'PIANIFICATA', '2025-04-15', NULL, 'Potatura di formazione', 5, 4);

-- Attività per Coltivazione 6 (Menta - Progetto 2)
INSERT INTO attivita (nome, stato, data_pianificazione, data_inizio, note_tecniche, id_coltivazione, id_coltivatore) VALUES
('Trapianto Menta', 'PIANIFICATA', '2025-02-16', '2025-02-18', 'Divisione cespi e trapianto', 6, 4),
('Raccolta Menta', 'PIANIFICATA', '2025-03-10', '2025-03-12', 'Prima raccolta foglie fresche', 6, 2);
...
INSERT INTO attivita (nome, stato, data_pianificazione, data_inizio, note_tecniche, id_coltivazione, id_coltivatore) VALUES
('Semina Prezzemolo', 'PIANIFICATA', '2025-02-20', '2025-02-22', 'Semina in file, germinazione lenta', 7, 2),
('Irrigazione Prezzemolo', 'PIANIFICATA', '2025-03-01', '2025-03-03', 'Mantenere terreno umido', 7, 4);

-- Attività per Coltivazioni Concluse (Progetto 3)
INSERT INTO attivita (nome, stato, data_pianificazione, data_inizio, note_tecniche, id_coltivazione, id_coltivatore) VALUES
('Semina Zucchine', 'PIANIFICATA', '2024-05-28', '2024-06-05', 'Semina diretta a postarelle', 8, 3),
('Raccolta Zucchine', 'PIANIFICATA', '2024-07-15', '2024-07-20', 'Raccolta scalare tri-settimanale', 8, 3),
('Trapianto Peperoni', 'PIANIFICATA', '2024-06-08', '2024-06-10', 'Piantine da vivaio', 9, 3),
('Raccolta Peperoni', 'PIANIFICATA', '2024-08-20', '2024-08-25', 'Raccolta a maturazione completa', 9, 3);
